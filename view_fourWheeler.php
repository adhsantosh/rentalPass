...
<head>
    ...
    <title>Available Four-Wheelers</title>
                            ...
                            <div class='card h-100'>
                                ...
                                <div class='card-body d-flex flex-column justify-content-between'>
                                    <div>
                                        ...
                                        <p class='card-text'><strong>Model:</strong> " . htmlspecialchars($vehicle['model']) . "</p>
                                        <p class='card-text'><strong>Price:</strong> Rs. " . htmlspecialchars($vehicle['price']) . " / day</p>
                                    </div>
                                    <a href='rent_vehicle.php?fwid=" . htmlspecialchars($vehicle['FWID']) . "' class='btn btn-primary mt-3'>Rent Now</a>
                                </div>
                            </div>
                        </div>";
                    }
